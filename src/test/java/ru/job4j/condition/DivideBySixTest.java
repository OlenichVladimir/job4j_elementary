...
public class DivideBySixTest {
    ...
    public void whenNumberDivideBy6() {
        ...
        String expected = "Это число делится на 6.";
    ...
    public void whenNumberDivideBy3AndNotEven() {
        int in = 9;
        String result = DivideBySix.checkNumber(in);
        String expected = "Число делится на 3, но это не четное число.";
        assertThat(result).isEqualTo(expected);
    }
    ...
    public void whenNumberNoDivideBy3AndEven() {
        int in = 14;
        String result = DivideBySix.checkNumber(in);
        String expected = "Это число не делится на 3, но это четное число.";
        assertThat(result).isEqualTo(expected);
    }
    ...
    public void whenNumberNoDivideBy3AndNotEven() {
        int in = 25;
        String result = DivideBySix.checkNumber(in);
        String expected = "Это число не делится на 3, и это не четное число.";
        assertThat(result).isEqualTo(expected);
    }
}